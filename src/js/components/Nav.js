...
export default class Nav extends Component {
  ...
  preload(){
    ...
    SweetAlert({
      ...
      this.props.history.push('/category/catalog/0/0/0/1/0/' + this.props.state.lang);
...
//
	...
	searchPhpFunc = async(word) => {
			this.setState({preload: true});
			let agent = false;
			localStorage.agent ? agent = localStorage.agentExId : null;
  ...
  search = (e) =>{
     ...
     let value = e.target.value;
		  ...
		  if(inputLength === 0){
				  ...
				  timeoutId = setTimeout(() => this.searchPhpFunc(word), 500);
		  }
            ...
            */}
                ...
                :null}
		                  ...
		                  :null}
									...
									:
									<button onClick={this.getUsers} className="get-users">החל</button>
									}
								</Fragment>
							*/}
					</div>
								...
								{element.Password ?
									<Fragment>
										{element.Password == 1 && this.props.state.adminPass1 && this.props.state.adminPass1 == this.state.adminPass1 || element.Password == 2 && this.props.state.adminPass2 && this.props.state.adminPass2 == this.state.adminPass2 ?
											<NavLink onClick={this.props.toggleMenu.bind(this)} to={!element.isLang ? element.Link : element.Link+'/'+this.props.state.lang}>
