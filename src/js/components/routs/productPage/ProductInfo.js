...
export default class ProductInfo extends Component {
	constructor(props) {
		...
		this.state = {
			...
			productsQP: [],
			productsToUse: [],
			allProds: this.props.props.state.products && this.props.props.state.products.length > 0 ? this.props.props.state.products : this.props.props.props.state.productsInCart && this.props.props.props.state.productsInCart.length ? this.props.props.props.state.productsInCart:[]
		}
			...
			<div className="wrapper">
							...
							<div key={index} className="flex-container for-quantity">
								...
								<div className="col-lg-4 price">
									...
									{element.Discount && !element.SpecialPrice ?
										<p>{(parseFloat(element.Price) - (parseFloat(element.Price) * parseFloat(element.Discount)) / 100).toFixed(1)}</p>
										: null}
								</div>
							</div>
						);
                ...
                */}
                  ...
                  */}
								...
								<div className="col-lg-5 second-prod-maincont">
									{element.Price ?
										<h3 className="fixedPrice">{'ב- ' + parseFloat(element.Price).toFixed(1) + ' ₪ בלבד'}</h3>
										:
